...
func initSystemMaintenanceGroupMembersBgp(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"network-instance": initSystemMaintenanceGroupMembersBgpNetworkinstance,
	}
	e := &yentry.Entry{
		Name:             "bgp",
		Key:              []string{},
