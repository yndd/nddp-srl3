...
func initNetworkinstanceProtocolsIgmpInterface(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"ssm":           initNetworkinstanceProtocolsIgmpInterfaceSsm,
		"static":        initNetworkinstanceProtocolsIgmpInterfaceStatic,
		"trace-options": initNetworkinstanceProtocolsIgmpInterfaceTraceoptions,
	}
	e := &yentry.Entry{
		Name: "interface",
		Key: []string{
