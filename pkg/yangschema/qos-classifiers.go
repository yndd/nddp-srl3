...
func initQosClassifiers(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"dscp-policy":               initQosClassifiersDscppolicy,
		"mpls-traffic-class-policy": initQosClassifiersMplstrafficclasspolicy,
	}
	e := &yentry.Entry{
		Name:             "classifiers",
		Key:              []string{},
