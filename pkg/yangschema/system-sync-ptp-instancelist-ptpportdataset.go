...
func initSystemSyncPtpInstancelistPtpportdataset(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"port-ds-list": initSystemSyncPtpInstancelistPtpportdatasetPortdslist,
	}
	e := &yentry.Entry{
		Name:             "ptp-port-data-set",
		Key:              []string{},
		Module:           "",
		Namespace:        "",
