...
func initInterfaceSubinterfaceIpv6VrrpVrrpgroupInterfacetracking(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"track-interface": initInterfaceSubinterfaceIpv6VrrpVrrpgroupInterfacetrackingTrackinterface,
	}
	e := &yentry.Entry{
