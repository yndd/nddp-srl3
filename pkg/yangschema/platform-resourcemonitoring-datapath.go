...
func initPlatformResourcemonitoringDatapath(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"asic": initPlatformResourcemonitoringDatapathAsic,
		"xdp":  initPlatformResourcemonitoringDatapathXdp,
	}
	e := &yentry.Entry{
		Name:             "datapath",
		Key:              []string{},
