...
func initRoutingpolicy(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"as-path-set":   initRoutingpolicyAspathset,
		"community-set": initRoutingpolicyCommunityset,
		"policy":        initRoutingpolicyPolicy,
		"prefix-set":    initRoutingpolicyPrefixset,
	}
	e := &yentry.Entry{
		Name:             "routing-policy",
		Key:              []string{},
