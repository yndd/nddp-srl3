...
func initSystemNetworkinstanceProtocolsEvpnEthernetsegmentsBgpinstanceEthernetsegmentDfelectionInterfacestandbysignalingonnondf(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{}
	e := &yentry.Entry{
		Name:             "interface-standby-signaling-on-non-df",
		Key:              []string{},
		Module:           "",
		Namespace:        "",
