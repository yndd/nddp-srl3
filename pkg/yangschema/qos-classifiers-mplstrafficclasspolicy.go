...
func initQosClassifiersMplstrafficclasspolicy(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"traffic-class": initQosClassifiersMplstrafficclasspolicyTrafficclass,
	}
	e := &yentry.Entry{
		Name: "mpls-traffic-class-policy",
		Key: []string{
			"name",
		},
		Module:           "",
