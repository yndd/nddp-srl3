...
func initOamEthcfmDomainAssociationMepPmonTwowaydm(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"session": initOamEthcfmDomainAssociationMepPmonTwowaydmSession,
	}
	e := &yentry.Entry{
		Name:             "two-way-dm",
		Key:              []string{},
