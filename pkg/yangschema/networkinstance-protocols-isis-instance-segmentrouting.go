...
func initNetworkinstanceProtocolsIsisInstanceSegmentrouting(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"mpls": initNetworkinstanceProtocolsIsisInstanceSegmentroutingMpls,
	}
	e := &yentry.Entry{
