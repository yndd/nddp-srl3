...
func initOamEthcfmPmontemplateMeasurementinterval(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"duration": initOamEthcfmPmontemplateMeasurementintervalDuration,
	}
	e := &yentry.Entry{
