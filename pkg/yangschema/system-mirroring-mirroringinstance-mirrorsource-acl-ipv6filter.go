...
func initSystemMirroringMirroringinstanceMirrorsourceAclIpv6filter(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"entry": initSystemMirroringMirroringinstanceMirrorsourceAclIpv6filterEntry,
	}
	e := &yentry.Entry{
		Name: "ipv6-filter",
		Key: []string{
