...
func initNetworkinstanceProtocolsIgmpInterfaceSsm(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"mappings": initNetworkinstanceProtocolsIgmpInterfaceSsmMappings,
	}
	e := &yentry.Entry{
		Name:             "ssm",
		Key:              []string{},
