...
func initInterfaceSubinterfaceIpv4ArpVirtualipv4discovery(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"address": initInterfaceSubinterfaceIpv4ArpVirtualipv4discoveryAddress,
	}
	e := &yentry.Entry{
		Name:             "virtual-ipv4-discovery",
		Key:              []string{},
