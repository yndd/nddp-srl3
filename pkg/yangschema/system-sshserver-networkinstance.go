...
func initSystemSshserverNetworkinstance(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"source-address": initSystemSshserverNetworkinstanceSourceaddress,
	}
	e := &yentry.Entry{
