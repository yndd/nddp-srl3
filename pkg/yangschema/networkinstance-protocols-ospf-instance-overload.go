...
func initNetworkinstanceProtocolsOspfInstanceOverload(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"overload-on-boot":  initNetworkinstanceProtocolsOspfInstanceOverloadOverloadonboot,
		"rtr-adv-lsa-limit": initNetworkinstanceProtocolsOspfInstanceOverloadRtradvlsalimit,
	}
	e := &yentry.Entry{
		Name:             "overload",
		Key:              []string{},
