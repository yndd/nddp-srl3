...
func initNetworkinstanceProtocolsDirectlyconnected(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"te-database-install": initNetworkinstanceProtocolsDirectlyconnectedTedatabaseinstall,
	}
	e := &yentry.Entry{
