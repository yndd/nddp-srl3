...
func initNetworkinstanceProtocolsMldTraceoptionsTrace(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"packet": initNetworkinstanceProtocolsMldTraceoptionsTracePacket,
	}
	e := &yentry.Entry{
		Name:             "trace",
		Key:              []string{},
