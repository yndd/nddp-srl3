...
func initNetworkinstanceProtocolsBgpTraceoptions(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"flag": initNetworkinstanceProtocolsBgpTraceoptionsFlag,
	}
	e := &yentry.Entry{
		Name:             "trace-options",
		Key:              []string{},
