...
func initAclCapturefilterIpv4filterEntryMatchDestinationport(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"range": initAclCapturefilterIpv4filterEntryMatchDestinationportRange,
	}
	e := &yentry.Entry{
