...
func initSystemNetworkinstanceProtocolsEvpnEthernetsegments(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bgp-instance": initSystemNetworkinstanceProtocolsEvpnEthernetsegmentsBgpinstance,
		"timers":       initSystemNetworkinstanceProtocolsEvpnEthernetsegmentsTimers,
	}
	e := &yentry.Entry{
