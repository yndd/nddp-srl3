...
func initOamEthcfmDomainAssociationMepPmonOnewaydmSession(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
		...
		LeafRefs: []*leafref.LeafRef{
			{
				...
				RemotePath: &gnmi.Path{
					Elem: []*gnmi.PathElem{
						...
						{Name: "ethcfm"},
						{Name: "pmon-template"},
						{Name: "bin-group", Key: map[string]string{"bg-id": ""}},
					},
				},
			},
			{
