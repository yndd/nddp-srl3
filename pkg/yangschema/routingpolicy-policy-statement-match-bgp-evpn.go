...
func initRoutingpolicyPolicyStatementMatchBgpEvpn(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"route-type": initRoutingpolicyPolicyStatementMatchBgpEvpnRoutetype,
	}
	e := &yentry.Entry{
		Name:             "evpn",
		Key:              []string{},
