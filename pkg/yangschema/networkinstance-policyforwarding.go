...
func initNetworkinstancePolicyforwarding(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"interface": initNetworkinstancePolicyforwardingInterface,
		"policy":    initNetworkinstancePolicyforwardingPolicy,
	}
	e := &yentry.Entry{
		Name:             "policy-forwarding",
		Key:              []string{},
