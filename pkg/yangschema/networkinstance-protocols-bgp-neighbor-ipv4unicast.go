...
func initNetworkinstanceProtocolsBgpNeighborIpv4unicast(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"prefix-limit": initNetworkinstanceProtocolsBgpNeighborIpv4unicastPrefixlimit,
	}
	e := &yentry.Entry{
		Name:             "ipv4-unicast",
		Key:              []string{},
