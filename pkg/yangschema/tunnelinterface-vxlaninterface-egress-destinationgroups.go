...
func initTunnelinterfaceVxlaninterfaceEgressDestinationgroups(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"group": initTunnelinterfaceVxlaninterfaceEgressDestinationgroupsGroup,
	}
	e := &yentry.Entry{
