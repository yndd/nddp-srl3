...
func initPlatformResourcemonitoringDatapathAsic(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"resource": initPlatformResourcemonitoringDatapathAsicResource,
	}
	e := &yentry.Entry{
		Name:             "asic",
		Key:              []string{},
