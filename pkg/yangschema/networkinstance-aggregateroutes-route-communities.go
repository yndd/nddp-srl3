...
func initNetworkinstanceAggregateroutesRouteCommunities(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"add": initNetworkinstanceAggregateroutesRouteCommunitiesAdd,
	}
	e := &yentry.Entry{
		Name:             "communities",
		Key:              []string{},
