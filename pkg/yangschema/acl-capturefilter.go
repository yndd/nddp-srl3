...
func initAclCapturefilter(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"ipv4-filter": initAclCapturefilterIpv4filter,
		"ipv6-filter": initAclCapturefilterIpv6filter,
	}
	e := &yentry.Entry{
		Name:             "capture-filter",
		Key:              []string{},
