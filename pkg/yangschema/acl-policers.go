...
func initAclPolicers(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"policer":            initAclPolicersPolicer,
		"system-cpu-policer": initAclPolicersSystemcpupolicer,
	}
	e := &yentry.Entry{
		Name:             "policers",
		Key:              []string{},
