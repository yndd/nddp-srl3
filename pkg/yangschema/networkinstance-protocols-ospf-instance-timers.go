...
func initNetworkinstanceProtocolsOspfInstanceTimers(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"lsa-generate": initNetworkinstanceProtocolsOspfInstanceTimersLsagenerate,
		"spf-wait":     initNetworkinstanceProtocolsOspfInstanceTimersSpfwait,
	}
	e := &yentry.Entry{
		Name:             "timers",
		Key:              []string{},
