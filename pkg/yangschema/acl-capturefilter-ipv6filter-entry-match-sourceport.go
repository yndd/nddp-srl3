...
func initAclCapturefilterIpv6filterEntryMatchSourceport(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"range": initAclCapturefilterIpv6filterEntryMatchSourceportRange,
	}
	e := &yentry.Entry{
		Name:             "source-port",
		Key:              []string{},
