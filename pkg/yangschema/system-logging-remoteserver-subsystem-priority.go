...
func initSystemLoggingRemoteserverSubsystemPriority(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"match-exact": initSystemLoggingRemoteserverSubsystemPriorityMatchexact,
	}
	e := &yentry.Entry{
		Name:             "priority",
		Key:              []string{},
