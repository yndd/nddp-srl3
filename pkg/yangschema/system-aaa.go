...
func initSystemAaa(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"accounting":     initSystemAaaAccounting,
		"authentication": initSystemAaaAuthentication,
		"authorization":  initSystemAaaAuthorization,
		"server-group":   initSystemAaaServergroup,
	}
	e := &yentry.Entry{
		Name:             "aaa",
		Key:              []string{},
