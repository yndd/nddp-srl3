...
func initNetworkinstancePolicyforwardingPolicyRuleMatch(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"ipv4": initNetworkinstancePolicyforwardingPolicyRuleMatchIpv4,
	}
	e := &yentry.Entry{
		Name:             "match",
		Key:              []string{},
