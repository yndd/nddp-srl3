...
func initNetworkinstanceNexthopgroupsGroup(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"blackhole": initNetworkinstanceNexthopgroupsGroupBlackhole,
		"nexthop":   initNetworkinstanceNexthopgroupsGroupNexthop,
	}
	e := &yentry.Entry{
		Name: "group",
		Key: []string{
