...
func initInterfaceSubinterfaceIpv6NeighbordiscoveryEvpn(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"advertise": initInterfaceSubinterfaceIpv6NeighbordiscoveryEvpnAdvertise,
	}
	e := &yentry.Entry{
		Name:             "evpn",
		Key:              []string{},
