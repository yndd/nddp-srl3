...
func initSystemSyncPtp(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"instance-list": initSystemSyncPtpInstancelist,
	}
	e := &yentry.Entry{
		Name:             "ptp",
		Key:              []string{},
		...
		Defaults: map[string]string{
			"frequency-ref": "layer1a",
			"ptp-profile":   "itug8275dot1",
			"time-ref":      "ptp",
			"tod-msg-type":  "itu",
		},
	}
