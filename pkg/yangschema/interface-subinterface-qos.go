...
func initInterfaceSubinterfaceQos(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"input":  initInterfaceSubinterfaceQosInput,
		"output": initInterfaceSubinterfaceQosOutput,
	}
	e := &yentry.Entry{
		Name:             "qos",
		Key:              []string{},
