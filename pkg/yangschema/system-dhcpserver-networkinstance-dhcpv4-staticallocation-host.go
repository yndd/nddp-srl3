...
func initSystemDhcpserverNetworkinstanceDhcpv4StaticallocationHost(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"options": initSystemDhcpserverNetworkinstanceDhcpv4StaticallocationHostOptions,
	}
	e := &yentry.Entry{
		Name: "host",
		Key: []string{
