...
func initNetworkinstanceProtocolsLdpIpv4(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"fec-resolution": initNetworkinstanceProtocolsLdpIpv4Fecresolution,
	}
	e := &yentry.Entry{
		Name:             "ipv4",
		Key:              []string{},
