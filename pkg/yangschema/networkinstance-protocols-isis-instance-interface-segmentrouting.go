...
func initNetworkinstanceProtocolsIsisInstanceInterfaceSegmentrouting(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"mpls": initNetworkinstanceProtocolsIsisInstanceInterfaceSegmentroutingMpls,
	}
	e := &yentry.Entry{
