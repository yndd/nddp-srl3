...
func initAclCpmfilterIpv6filterEntryMatchDestinationport(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"range": initAclCpmfilterIpv6filterEntryMatchDestinationportRange,
	}
	e := &yentry.Entry{
