...
func initAclCapturefilterIpv4filterEntryMatchIcmp(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"code": initAclCapturefilterIpv4filterEntryMatchIcmpCode,
	}
	e := &yentry.Entry{
		Name:             "icmp",
		Key:              []string{},
