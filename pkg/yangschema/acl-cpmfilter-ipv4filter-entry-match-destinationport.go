...
func initAclCpmfilterIpv4filterEntryMatchDestinationport(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"range": initAclCpmfilterIpv4filterEntryMatchDestinationportRange,
	}
	e := &yentry.Entry{
