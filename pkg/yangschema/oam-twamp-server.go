...
func initOamTwampServer(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"client-connection": initOamTwampServerClientconnection,
		"session-reflector": initOamTwampServerSessionreflector,
	}
	e := &yentry.Entry{
		Name: "server",
		Key: []string{
