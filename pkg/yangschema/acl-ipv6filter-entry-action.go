...
func initAclIpv6filterEntryAction(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"accept": initAclIpv6filterEntryActionAccept,
		"drop":   initAclIpv6filterEntryActionDrop,
	}
	e := &yentry.Entry{
		Name:             "action",
		Key:              []string{},
