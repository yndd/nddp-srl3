...
func initRoutingpolicyPolicy(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"default-action": initRoutingpolicyPolicyDefaultaction,
		"statement":      initRoutingpolicyPolicyStatement,
	}
	e := &yentry.Entry{
		Name: "policy",
		Key: []string{
