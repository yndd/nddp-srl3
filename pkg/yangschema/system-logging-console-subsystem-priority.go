...
func initSystemLoggingConsoleSubsystemPriority(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"match-exact": initSystemLoggingConsoleSubsystemPriorityMatchexact,
	}
	e := &yentry.Entry{
		Name:             "priority",
		Key:              []string{},
