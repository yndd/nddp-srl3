...
func initNetworkinstanceProtocolsBgpevpnBgpinstance(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"routes": initNetworkinstanceProtocolsBgpevpnBgpinstanceRoutes,
	}
	e := &yentry.Entry{
		Name: "bgp-instance",
		Key: []string{
