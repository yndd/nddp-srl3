...
func initNetworkinstanceProtocolsMldInterfaceSsm(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"mappings": initNetworkinstanceProtocolsMldInterfaceSsmMappings,
	}
	e := &yentry.Entry{
		Name:             "ssm",
		Key:              []string{},
