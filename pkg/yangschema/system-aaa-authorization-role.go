...
func initSystemAaaAuthorizationRole(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"services": initSystemAaaAuthorizationRoleServices,
		"tacacs":   initSystemAaaAuthorizationRoleTacacs,
	}
	e := &yentry.Entry{
		Name: "role",
		Key: []string{
