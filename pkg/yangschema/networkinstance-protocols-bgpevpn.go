...
func initNetworkinstanceProtocolsBgpevpn(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bgp-instance": initNetworkinstanceProtocolsBgpevpnBgpinstance,
	}
	e := &yentry.Entry{
		Name:             "bgp-evpn",
		Key:              []string{},
