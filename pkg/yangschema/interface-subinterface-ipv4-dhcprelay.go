...
func initInterfaceSubinterfaceIpv4Dhcprelay(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"option":        initInterfaceSubinterfaceIpv4DhcprelayOption,
		"server":        initInterfaceSubinterfaceIpv4DhcprelayServer,
		"trace-options": initInterfaceSubinterfaceIpv4DhcprelayTraceoptions,
	}
	e := &yentry.Entry{
		Name:             "dhcp-relay",
		Key:              []string{},
		...
		Defaults: map[string]string{
			"admin-state":                "enable",
			"use-gi-addr-as-src-ip-addr": "false",
		},
	}
