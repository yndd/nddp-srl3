...
func initRoutingpolicyPolicyStatementActionAccept(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bgp": initRoutingpolicyPolicyStatementActionAcceptBgp,
	}
	e := &yentry.Entry{
		Name:             "accept",
		Key:              []string{},
