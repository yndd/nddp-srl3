...
func initInterfaceSubinterfaceIpv4Dhcpclient(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"trace-options": initInterfaceSubinterfaceIpv4DhcpclientTraceoptions,
	}
	e := &yentry.Entry{
		Name:             "dhcp-client",
		Key:              []string{},
