...
func initSystemAaaAuthenticationUser(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"role":    initSystemAaaAuthenticationUserRole,
		"ssh-key": initSystemAaaAuthenticationUserSshkey,
	}
	e := &yentry.Entry{
		Name: "user",
		Key: []string{
