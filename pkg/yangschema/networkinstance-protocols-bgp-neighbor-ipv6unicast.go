...
func initNetworkinstanceProtocolsBgpNeighborIpv6unicast(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"prefix-limit": initNetworkinstanceProtocolsBgpNeighborIpv6unicastPrefixlimit,
	}
	e := &yentry.Entry{
		Name:             "ipv6-unicast",
		Key:              []string{},
