...
func initNetworkinstancePolicyforwardingInterface(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
		...
		LeafRefs: []*leafref.LeafRef{
			{
				...
				RemotePath: &gnmi.Path{
					Elem: []*gnmi.PathElem{
						...
						{Name: "policy", Key: map[string]string{"policy-id": ""}},
					},
				},
			},
			{
