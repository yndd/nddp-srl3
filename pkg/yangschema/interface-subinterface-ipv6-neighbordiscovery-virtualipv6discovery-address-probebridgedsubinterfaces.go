...
func initInterfaceSubinterfaceIpv6NeighbordiscoveryVirtualipv6discoveryAddressProbebridgedsubinterfaces(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{}
	e := &yentry.Entry{
		Name:             "probe-bridged-subinterfaces",
		Key:              []string{},
		Module:           "",
		Namespace:        "",
