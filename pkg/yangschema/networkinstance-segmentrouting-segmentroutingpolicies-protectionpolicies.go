...
func initNetworkinstanceSegmentroutingSegmentroutingpoliciesProtectionpolicies(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"policy": initNetworkinstanceSegmentroutingSegmentroutingpoliciesProtectionpoliciesPolicy,
	}
	e := &yentry.Entry{
