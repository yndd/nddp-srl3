...
func initSystemNetworkinstanceProtocolsEvpn(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"ethernet-segments": initSystemNetworkinstanceProtocolsEvpnEthernetsegments,
	}
	e := &yentry.Entry{
		Name:             "evpn",
		Key:              []string{},
