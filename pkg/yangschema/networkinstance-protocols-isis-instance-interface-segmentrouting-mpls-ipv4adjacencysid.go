...
func initNetworkinstanceProtocolsIsisInstanceInterfaceSegmentroutingMplsIpv4adjacencysid(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{}
	e := &yentry.Entry{
		Name:             "ipv4-adjacency-sid",
		Key:              []string{},
		Module:           "",
		Namespace:        "",
