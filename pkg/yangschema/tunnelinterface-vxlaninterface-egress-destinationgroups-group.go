...
func initTunnelinterfaceVxlaninterfaceEgressDestinationgroupsGroup(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"destination": initTunnelinterfaceVxlaninterfaceEgressDestinationgroupsGroupDestination,
	}
	e := &yentry.Entry{
		Name: "group",
		Key: []string{
