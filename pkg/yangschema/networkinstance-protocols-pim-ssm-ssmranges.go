...
func initNetworkinstanceProtocolsPimSsmSsmranges(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"group-range": initNetworkinstanceProtocolsPimSsmSsmrangesGrouprange,
	}
	e := &yentry.Entry{
		Name:             "ssm-ranges",
		Key:              []string{},
