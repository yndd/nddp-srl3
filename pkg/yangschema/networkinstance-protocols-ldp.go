...
func initNetworkinstanceProtocolsLdp(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"discovery":        initNetworkinstanceProtocolsLdpDiscovery,
		"graceful-restart": initNetworkinstanceProtocolsLdpGracefulrestart,
		"ipv4":             initNetworkinstanceProtocolsLdpIpv4,
		"multipath":        initNetworkinstanceProtocolsLdpMultipath,
		"peers":            initNetworkinstanceProtocolsLdpPeers,
	}
	e := &yentry.Entry{
		Name:             "ldp",
		Key:              []string{},
