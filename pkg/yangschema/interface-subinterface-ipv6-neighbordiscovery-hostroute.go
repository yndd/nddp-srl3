...
func initInterfaceSubinterfaceIpv6NeighbordiscoveryHostroute(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"populate": initInterfaceSubinterfaceIpv6NeighbordiscoveryHostroutePopulate,
	}
	e := &yentry.Entry{
		Name:             "host-route",
		Key:              []string{},
