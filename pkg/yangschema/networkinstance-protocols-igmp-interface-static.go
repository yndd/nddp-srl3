...
func initNetworkinstanceProtocolsIgmpInterfaceStatic(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"group-range": initNetworkinstanceProtocolsIgmpInterfaceStaticGrouprange,
	}
	e := &yentry.Entry{
		Name:             "static",
		Key:              []string{},
