...
func initOamEthcfmPmontemplateBingroupBintype(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bin":         initOamEthcfmPmontemplateBingroupBintypeBin,
		"delay-event": initOamEthcfmPmontemplateBingroupBintypeDelayevent,
	}
	e := &yentry.Entry{
		Name: "bin-type",
		Key: []string{
