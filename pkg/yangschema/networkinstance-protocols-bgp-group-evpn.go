...
func initNetworkinstanceProtocolsBgpGroupEvpn(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"prefix-limit": initNetworkinstanceProtocolsBgpGroupEvpnPrefixlimit,
	}
	e := &yentry.Entry{
		Name:             "evpn",
		Key:              []string{},
