...
func initAclSystemfilterIpv4filterEntry(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"action": initAclSystemfilterIpv4filterEntryAction,
		"match":  initAclSystemfilterIpv4filterEntryMatch,
	}
	e := &yentry.Entry{
		Name: "entry",
		Key: []string{
