...
func initNetworkinstanceProtocolsIgmpTraceoptions(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"trace": initNetworkinstanceProtocolsIgmpTraceoptionsTrace,
	}
	e := &yentry.Entry{
		Name:             "trace-options",
		Key:              []string{},
