...
func initNetworkinstanceProtocolsBgpIpv4unicastNexthopresolution(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"ipv4-next-hops": initNetworkinstanceProtocolsBgpIpv4unicastNexthopresolutionIpv4nexthops,
	}
	e := &yentry.Entry{
