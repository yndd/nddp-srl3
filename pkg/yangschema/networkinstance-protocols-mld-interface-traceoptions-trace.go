...
func initNetworkinstanceProtocolsMldInterfaceTraceoptionsTrace(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"packet": initNetworkinstanceProtocolsMldInterfaceTraceoptionsTracePacket,
	}
	e := &yentry.Entry{
		Name:             "trace",
		Key:              []string{},
