...
func initAclSystemfilterIpv6filterEntryAction(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"accept": initAclSystemfilterIpv6filterEntryActionAccept,
		"drop":   initAclSystemfilterIpv6filterEntryActionDrop,
	}
	e := &yentry.Entry{
		Name:             "action",
		Key:              []string{},
