...
func initSystemMaintenanceGroupMembersBgpNetworkinstance(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"neighbor":   initSystemMaintenanceGroupMembersBgpNetworkinstanceNeighbor,
		"peer-group": initSystemMaintenanceGroupMembersBgpNetworkinstancePeergroup,
	}
	e := &yentry.Entry{
