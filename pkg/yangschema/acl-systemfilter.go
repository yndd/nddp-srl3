...
func initAclSystemfilter(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"ipv4-filter": initAclSystemfilterIpv4filter,
		"ipv6-filter": initAclSystemfilterIpv6filter,
	}
	e := &yentry.Entry{
		Name:             "system-filter",
		Key:              []string{},
