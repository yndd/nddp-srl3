...
func initInterfaceRadioRoePrestimeoffset(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{}
	e := &yentry.Entry{
		Name:             "pres-time-offset",
		Key:              []string{},
		Module:           "",
		Namespace:        "",
		...
		Defaults: map[string]string{
			"fractional-nanosecond": "0",
			"integer-nanosecond":    "100000",
		},
	}
