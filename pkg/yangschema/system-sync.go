...
func initSystemSync(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bits":            initSystemSyncBits,
		"freq-clock":      initSystemSyncFreqclock,
		"freq-references": initSystemSyncFreqreferences,
		"ppstest":         initSystemSyncPpstest,
		"ptp":             initSystemSyncPtp,
		"tod":             initSystemSyncTod,
	}
	e := &yentry.Entry{
		Name:             "sync",
		Key:              []string{},
