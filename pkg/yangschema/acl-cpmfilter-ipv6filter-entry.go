...
func initAclCpmfilterIpv6filterEntry(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"action": initAclCpmfilterIpv6filterEntryAction,
		"match":  initAclCpmfilterIpv6filterEntryMatch,
	}
	e := &yentry.Entry{
		Name: "entry",
		Key: []string{
