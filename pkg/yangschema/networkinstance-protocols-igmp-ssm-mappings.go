...
func initNetworkinstanceProtocolsIgmpSsmMappings(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"group-range": initNetworkinstanceProtocolsIgmpSsmMappingsGrouprange,
	}
	e := &yentry.Entry{
		Name:             "mappings",
		Key:              []string{},
