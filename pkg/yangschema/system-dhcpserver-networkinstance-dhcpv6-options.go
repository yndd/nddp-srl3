...
func initSystemDhcpserverNetworkinstanceDhcpv6Options(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"dns-server": initSystemDhcpserverNetworkinstanceDhcpv6OptionsDnsserver,
	}
	e := &yentry.Entry{
		Name:             "options",
		Key:              []string{},
