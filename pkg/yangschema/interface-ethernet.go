...
func initInterfaceEthernet(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"flow-control":  initInterfaceEthernetFlowcontrol,
		"hold-time":     initInterfaceEthernetHoldtime,
		"storm-control": initInterfaceEthernetStormcontrol,
		"synce":         initInterfaceEthernetSynce,
	}
	e := &yentry.Entry{
		Name:             "ethernet",
		Key:              []string{},
