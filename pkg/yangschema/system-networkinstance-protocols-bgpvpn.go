...
func initSystemNetworkinstanceProtocolsBgpvpn(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bgp-instance": initSystemNetworkinstanceProtocolsBgpvpnBgpinstance,
	}
	e := &yentry.Entry{
		Name:             "bgp-vpn",
		Key:              []string{},
