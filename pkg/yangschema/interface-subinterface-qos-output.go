...
func initInterfaceSubinterfaceQosOutput(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"rewrite-rules": initInterfaceSubinterfaceQosOutputRewriterules,
	}
	e := &yentry.Entry{
		Name:             "output",
		Key:              []string{},
