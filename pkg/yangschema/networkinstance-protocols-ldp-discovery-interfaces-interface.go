...
func initNetworkinstanceProtocolsLdpDiscoveryInterfacesInterface(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"ipv4": initNetworkinstanceProtocolsLdpDiscoveryInterfacesInterfaceIpv4,
	}
	e := &yentry.Entry{
		Name: "interface",
		Key: []string{
