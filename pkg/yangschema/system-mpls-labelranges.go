...
func initSystemMplsLabelranges(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"dynamic": initSystemMplsLabelrangesDynamic,
		"static":  initSystemMplsLabelrangesStatic,
	}
	e := &yentry.Entry{
		Name:             "label-ranges",
		Key:              []string{},
