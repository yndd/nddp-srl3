...
func initOamEthcfmDomainAssociationMepPmonOnewaydm(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"session": initOamEthcfmDomainAssociationMepPmonOnewaydmSession,
	}
	e := &yentry.Entry{
		Name:             "one-way-dm",
		Key:              []string{},
