...
func initNetworkinstanceSegmentroutingSegmentroutingpoliciesStaticpolicies(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"policy": initNetworkinstanceSegmentroutingSegmentroutingpoliciesStaticpoliciesPolicy,
	}
	e := &yentry.Entry{
