...
func initSystemLoggingBufferSubsystemPriority(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"match-exact": initSystemLoggingBufferSubsystemPriorityMatchexact,
	}
	e := &yentry.Entry{
		Name:             "priority",
		Key:              []string{},
