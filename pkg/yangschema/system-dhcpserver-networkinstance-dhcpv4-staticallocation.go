...
func initSystemDhcpserverNetworkinstanceDhcpv4Staticallocation(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"host": initSystemDhcpserverNetworkinstanceDhcpv4StaticallocationHost,
	}
	e := &yentry.Entry{
