...
func initAclSystemfilterIpv4filterEntryMatchDestinationport(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"range": initAclSystemfilterIpv4filterEntryMatchDestinationportRange,
	}
	e := &yentry.Entry{
