...
func initNetworkinstanceProtocolsIsisInstanceInterfaceSegmentroutingMplsIpv6adjacencysid(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{}
	e := &yentry.Entry{
		Name:             "ipv6-adjacency-sid",
		Key:              []string{},
		Module:           "",
		Namespace:        "",
