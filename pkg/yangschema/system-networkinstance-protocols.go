...
func initSystemNetworkinstanceProtocols(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bgp-vpn": initSystemNetworkinstanceProtocolsBgpvpn,
		"evpn":    initSystemNetworkinstanceProtocolsEvpn,
	}
	e := &yentry.Entry{
		Name:             "protocols",
		Key:              []string{},
