...
func initSystemDhcpserverNetworkinstanceDhcpv6Traceoptions(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"trace": initSystemDhcpserverNetworkinstanceDhcpv6TraceoptionsTrace,
	}
	e := &yentry.Entry{
		Name:             "trace-options",
		Key:              []string{},
