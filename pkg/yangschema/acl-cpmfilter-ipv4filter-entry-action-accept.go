...
func initAclCpmfilterIpv4filterEntryActionAccept(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"rate-limit": initAclCpmfilterIpv4filterEntryActionAcceptRatelimit,
	}
	e := &yentry.Entry{
		Name:             "accept",
		Key:              []string{},
