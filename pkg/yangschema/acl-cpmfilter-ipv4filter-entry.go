...
func initAclCpmfilterIpv4filterEntry(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"action": initAclCpmfilterIpv4filterEntryAction,
		"match":  initAclCpmfilterIpv4filterEntryMatch,
	}
	e := &yentry.Entry{
		Name: "entry",
		Key: []string{
