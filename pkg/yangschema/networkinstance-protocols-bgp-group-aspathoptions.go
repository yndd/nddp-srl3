...
func initNetworkinstanceProtocolsBgpGroupAspathoptions(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"remove-private-as": initNetworkinstanceProtocolsBgpGroupAspathoptionsRemoveprivateas,
	}
	e := &yentry.Entry{
