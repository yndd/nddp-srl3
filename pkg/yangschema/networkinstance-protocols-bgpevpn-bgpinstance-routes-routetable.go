...
func initNetworkinstanceProtocolsBgpevpnBgpinstanceRoutesRoutetable(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"mac-ip": initNetworkinstanceProtocolsBgpevpnBgpinstanceRoutesRoutetableMacip,
	}
	e := &yentry.Entry{
		Name:             "route-table",
		Key:              []string{},
