...
func initInterfaceSubinterfaceBridgetableMaclearning(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"aging": initInterfaceSubinterfaceBridgetableMaclearningAging,
	}
	e := &yentry.Entry{
		Name:             "mac-learning",
		Key:              []string{},
