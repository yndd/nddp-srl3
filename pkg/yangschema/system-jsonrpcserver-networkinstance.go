...
func initSystemJsonrpcserverNetworkinstance(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"http":  initSystemJsonrpcserverNetworkinstanceHttp,
		"https": initSystemJsonrpcserverNetworkinstanceHttps,
	}
	e := &yentry.Entry{
