...
func initNetworkinstanceProtocolsMldInterfaceStatic(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"group-range": initNetworkinstanceProtocolsMldInterfaceStaticGrouprange,
	}
	e := &yentry.Entry{
		Name:             "static",
		Key:              []string{},
