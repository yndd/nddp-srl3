...
func initSystemAaaAccounting(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"accounting-method": initSystemAaaAccountingAccountingmethod,
		"event":             initSystemAaaAccountingEvent,
	}
	e := &yentry.Entry{
		Name:             "accounting",
		Key:              []string{},
