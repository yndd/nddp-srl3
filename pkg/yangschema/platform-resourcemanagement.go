...
func initPlatformResourcemanagement(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"tcam":                         initPlatformResourcemanagementTcam,
		"unified-forwarding-resources": initPlatformResourcemanagementUnifiedforwardingresources,
	}
	e := &yentry.Entry{
