...
func initNetworkinstanceProtocolsDirectlyconnectedTedatabaseinstall(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bgp-ls": initNetworkinstanceProtocolsDirectlyconnectedTedatabaseinstallBgpls,
	}
	e := &yentry.Entry{
