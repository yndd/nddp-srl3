...
func initSystemMirroringMirroringinstanceMirrordestinationRemoteTunnelendpoints(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{}
	e := &yentry.Entry{
		Name:             "tunnel-end-points",
		Key:              []string{},
		Module:           "",
		Namespace:        "",
