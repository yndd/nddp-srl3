...
func initAclSystemfilterIpv6filterEntry(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"action": initAclSystemfilterIpv6filterEntryAction,
		"match":  initAclSystemfilterIpv6filterEntryMatch,
	}
	e := &yentry.Entry{
		Name: "entry",
		Key: []string{
