...
func initQos(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"classifiers":                      initQosClassifiers,
		"explicit-congestion-notification": initQosExplicitcongestionnotification,
		"queue-templates":                  initQosQueuetemplates,
		"rewrite-rules":                    initQosRewriterules,
	}
	e := &yentry.Entry{
		Name:             "qos",
		Key:              []string{},
