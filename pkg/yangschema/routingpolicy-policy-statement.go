...
func initRoutingpolicyPolicyStatement(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"action": initRoutingpolicyPolicyStatementAction,
		"match":  initRoutingpolicyPolicyStatementMatch,
	}
	e := &yentry.Entry{
		Name: "statement",
		Key: []string{
