...
func initAclCapturefilterIpv6filterEntryMatchDestinationport(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"range": initAclCapturefilterIpv6filterEntryMatchDestinationportRange,
	}
	e := &yentry.Entry{
