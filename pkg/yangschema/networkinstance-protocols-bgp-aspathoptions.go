...
func initNetworkinstanceProtocolsBgpAspathoptions(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"remove-private-as": initNetworkinstanceProtocolsBgpAspathoptionsRemoveprivateas,
	}
	e := &yentry.Entry{
