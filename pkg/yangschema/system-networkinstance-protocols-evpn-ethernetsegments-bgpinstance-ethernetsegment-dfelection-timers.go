...
func initSystemNetworkinstanceProtocolsEvpnEthernetsegmentsBgpinstanceEthernetsegmentDfelectionTimers(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
