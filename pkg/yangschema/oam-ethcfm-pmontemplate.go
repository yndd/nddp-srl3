...
func initOamEthcfmPmontemplate(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bin-group":            initOamEthcfmPmontemplateBingroup,
		"measurement-interval": initOamEthcfmPmontemplateMeasurementinterval,
	}
	e := &yentry.Entry{
		Name:             "pmon-template",
		Key:              []string{},
