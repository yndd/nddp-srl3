...
func initNetworkinstanceTrafficengineeringSharedrisklinkgroups(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"group": initNetworkinstanceTrafficengineeringSharedrisklinkgroupsGroup,
	}
	e := &yentry.Entry{
