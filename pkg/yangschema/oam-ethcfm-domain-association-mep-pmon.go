...
func initOamEthcfmDomainAssociationMepPmon(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"one-way-dm":  initOamEthcfmDomainAssociationMepPmonOnewaydm,
		"two-way-dm":  initOamEthcfmDomainAssociationMepPmonTwowaydm,
		"two-way-slm": initOamEthcfmDomainAssociationMepPmonTwowayslm,
	}
	e := &yentry.Entry{
		Name:             "pmon",
		Key:              []string{},
