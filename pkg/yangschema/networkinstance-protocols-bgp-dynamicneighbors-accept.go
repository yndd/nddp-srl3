...
func initNetworkinstanceProtocolsBgpDynamicneighborsAccept(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"match": initNetworkinstanceProtocolsBgpDynamicneighborsAcceptMatch,
	}
	e := &yentry.Entry{
		Name:             "accept",
		Key:              []string{},
