...
func initSystemGnmiserver(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"network-instance": initSystemGnmiserverNetworkinstance,
		"trace-options":    initSystemGnmiserverTraceoptions,
		"unix-socket":      initSystemGnmiserverUnixsocket,
	}
	e := &yentry.Entry{
		Name:             "gnmi-server",
		Key:              []string{},
