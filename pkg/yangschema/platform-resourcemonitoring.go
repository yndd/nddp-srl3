...
func initPlatformResourcemonitoring(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"acl":      initPlatformResourcemonitoringAcl,
		"datapath": initPlatformResourcemonitoringDatapath,
		"mtu":      initPlatformResourcemonitoringMtu,
		"qos":      initPlatformResourcemonitoringQos,
		"tcam":     initPlatformResourcemonitoringTcam,
	}
	e := &yentry.Entry{
