...
func initSystemJsonrpcserver(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"network-instance": initSystemJsonrpcserverNetworkinstance,
		"trace-options":    initSystemJsonrpcserverTraceoptions,
		"unix-socket":      initSystemJsonrpcserverUnixsocket,
	}
	e := &yentry.Entry{
