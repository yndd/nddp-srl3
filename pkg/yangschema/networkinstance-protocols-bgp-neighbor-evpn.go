...
func initNetworkinstanceProtocolsBgpNeighborEvpn(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"prefix-limit": initNetworkinstanceProtocolsBgpNeighborEvpnPrefixlimit,
	}
	e := &yentry.Entry{
		Name:             "evpn",
		Key:              []string{},
