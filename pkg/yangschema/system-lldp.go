...
func initSystemLldp(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bgp-auto-discovery": initSystemLldpBgpautodiscovery,
		"interface":          initSystemLldpInterface,
		"management-address": initSystemLldpManagementaddress,
		"trace-options":      initSystemLldpTraceoptions,
	}
	e := &yentry.Entry{
		Name:             "lldp",
		Key:              []string{},
