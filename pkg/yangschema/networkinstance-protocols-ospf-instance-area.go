...
func initNetworkinstanceProtocolsOspfInstanceArea(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"area-range": initNetworkinstanceProtocolsOspfInstanceAreaArearange,
		"interface":  initNetworkinstanceProtocolsOspfInstanceAreaInterface,
		"nssa":       initNetworkinstanceProtocolsOspfInstanceAreaNssa,
		"stub":       initNetworkinstanceProtocolsOspfInstanceAreaStub,
	}
	e := &yentry.Entry{
		Name: "area",
		Key: []string{
