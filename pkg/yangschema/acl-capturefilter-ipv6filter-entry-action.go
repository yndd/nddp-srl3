...
func initAclCapturefilterIpv6filterEntryAction(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"accept": initAclCapturefilterIpv6filterEntryActionAccept,
		"copy":   initAclCapturefilterIpv6filterEntryActionCopy,
	}
	e := &yentry.Entry{
		Name:             "action",
		Key:              []string{},
