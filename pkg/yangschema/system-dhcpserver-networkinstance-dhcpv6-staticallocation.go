...
func initSystemDhcpserverNetworkinstanceDhcpv6Staticallocation(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"host": initSystemDhcpserverNetworkinstanceDhcpv6StaticallocationHost,
	}
	e := &yentry.Entry{
