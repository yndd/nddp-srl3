...
func initSystemMaintenanceGroupMembersIsis(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"network-instances": initSystemMaintenanceGroupMembersIsisNetworkinstances,
	}
	e := &yentry.Entry{
		Name:             "isis",
		Key:              []string{},
