...
func initNetworkinstanceProtocolsIgmpSsmMappingsGrouprange(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"source": initNetworkinstanceProtocolsIgmpSsmMappingsGrouprangeSource,
	}
	e := &yentry.Entry{
		Name: "group-range",
		Key: []string{
