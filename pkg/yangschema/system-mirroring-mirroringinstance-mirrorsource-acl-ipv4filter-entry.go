...
func initSystemMirroringMirroringinstanceMirrorsourceAclIpv4filterEntry(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
		...
		LeafRefs: []*leafref.LeafRef{
			{
				...
				RemotePath: &gnmi.Path{
					Elem: []*gnmi.PathElem{
						...
						{Name: "name=current()"},
						{Name: "name]"},
						{Name: "entry", Key: map[string]string{"sequence-id": ""}},
					},
				},
			},
		},
