...
func initNetworkinstanceNexthopgroupsGroupNexthopFailuredetection(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"enable-bfd": initNetworkinstanceNexthopgroupsGroupNexthopFailuredetectionEnablebfd,
	}
	e := &yentry.Entry{
