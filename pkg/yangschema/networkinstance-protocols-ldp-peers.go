...
func initNetworkinstanceProtocolsLdpPeers(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"peer":          initNetworkinstanceProtocolsLdpPeersPeer,
		"trace-options": initNetworkinstanceProtocolsLdpPeersTraceoptions,
	}
	e := &yentry.Entry{
		Name:             "peers",
		Key:              []string{},
