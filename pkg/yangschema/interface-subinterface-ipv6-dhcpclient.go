...
func initInterfaceSubinterfaceIpv6Dhcpclient(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"trace-options": initInterfaceSubinterfaceIpv6DhcpclientTraceoptions,
	}
	e := &yentry.Entry{
		Name:             "dhcp-client",
		Key:              []string{},
