...
func initInterfaceSubinterfaceIpv6Routeradvertisement(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"debug":       initInterfaceSubinterfaceIpv6RouteradvertisementDebug,
		"router-role": initInterfaceSubinterfaceIpv6RouteradvertisementRouterrole,
	}
	e := &yentry.Entry{
