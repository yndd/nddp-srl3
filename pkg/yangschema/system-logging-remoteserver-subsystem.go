...
func initSystemLoggingRemoteserverSubsystem(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"priority": initSystemLoggingRemoteserverSubsystemPriority,
	}
	e := &yentry.Entry{
		Name: "subsystem",
		Key: []string{
