...
func initSystemMirroringMirroringinstanceMirrorsourceAclIpv4filter(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"entry": initSystemMirroringMirroringinstanceMirrorsourceAclIpv4filterEntry,
	}
	e := &yentry.Entry{
		Name: "ipv4-filter",
		Key: []string{
