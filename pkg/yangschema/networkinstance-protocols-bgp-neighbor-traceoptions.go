...
func initNetworkinstanceProtocolsBgpNeighborTraceoptions(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"flag": initNetworkinstanceProtocolsBgpNeighborTraceoptionsFlag,
	}
	e := &yentry.Entry{
		Name:             "trace-options",
		Key:              []string{},
