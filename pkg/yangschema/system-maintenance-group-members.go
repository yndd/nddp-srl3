...
func initSystemMaintenanceGroupMembers(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bgp":  initSystemMaintenanceGroupMembersBgp,
		"isis": initSystemMaintenanceGroupMembersIsis,
	}
	e := &yentry.Entry{
		Name:             "members",
		Key:              []string{},
