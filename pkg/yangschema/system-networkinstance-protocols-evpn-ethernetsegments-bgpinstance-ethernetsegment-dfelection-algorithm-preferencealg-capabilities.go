...
func initSystemNetworkinstanceProtocolsEvpnEthernetsegmentsBgpinstanceEthernetsegmentDfelectionAlgorithmPreferencealgCapabilities(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
