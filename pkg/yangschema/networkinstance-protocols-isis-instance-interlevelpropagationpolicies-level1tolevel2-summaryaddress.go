...
func initNetworkinstanceProtocolsIsisInstanceInterlevelpropagationpoliciesLevel1tolevel2Summaryaddress(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
