...
func initAclCapturefilterIpv6filterEntry(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"action": initAclCapturefilterIpv6filterEntryAction,
		"match":  initAclCapturefilterIpv6filterEntryMatch,
	}
	e := &yentry.Entry{
		Name: "entry",
		Key: []string{
