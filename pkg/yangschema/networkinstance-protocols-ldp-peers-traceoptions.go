...
func initNetworkinstanceProtocolsLdpPeersTraceoptions(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"trace": initNetworkinstanceProtocolsLdpPeersTraceoptionsTrace,
	}
	e := &yentry.Entry{
		Name:             "trace-options",
		Key:              []string{},
