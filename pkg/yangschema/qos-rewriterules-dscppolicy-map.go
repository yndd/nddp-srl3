...
func initQosRewriterulesDscppolicyMap(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"drop-probability": initQosRewriterulesDscppolicyMapDropprobability,
	}
	e := &yentry.Entry{
		Name: "map",
		Key: []string{
