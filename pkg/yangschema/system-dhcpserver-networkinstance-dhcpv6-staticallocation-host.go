...
func initSystemDhcpserverNetworkinstanceDhcpv6StaticallocationHost(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"options": initSystemDhcpserverNetworkinstanceDhcpv6StaticallocationHostOptions,
	}
	e := &yentry.Entry{
		Name: "host",
		Key: []string{
