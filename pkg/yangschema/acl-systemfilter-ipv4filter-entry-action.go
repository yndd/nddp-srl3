...
func initAclSystemfilterIpv4filterEntryAction(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"accept": initAclSystemfilterIpv4filterEntryActionAccept,
		"drop":   initAclSystemfilterIpv4filterEntryActionDrop,
	}
	e := &yentry.Entry{
		Name:             "action",
		Key:              []string{},
