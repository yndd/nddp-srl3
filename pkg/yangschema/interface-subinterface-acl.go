...
func initInterfaceSubinterfaceAcl(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"input":  initInterfaceSubinterfaceAclInput,
		"output": initInterfaceSubinterfaceAclOutput,
	}
	e := &yentry.Entry{
		Name:             "acl",
		Key:              []string{},
