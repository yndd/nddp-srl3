...
func initSystemMirroringMirroringinstanceMirrordestination(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"remote": initSystemMirroringMirroringinstanceMirrordestinationRemote,
	}
	e := &yentry.Entry{
		Name:             "mirror-destination",
		Key:              []string{},
		Module:           "",
		Namespace:        "",
