...
func initSystemLoggingFilterFacilityPriority(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"match-exact": initSystemLoggingFilterFacilityPriorityMatchexact,
	}
	e := &yentry.Entry{
		Name:             "priority",
		Key:              []string{},
