...
func initNetworkinstanceProtocolsBgpDynamicneighborsAcceptMatch(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"allowed-peer-as": initNetworkinstanceProtocolsBgpDynamicneighborsAcceptMatchAllowedpeeras,
	}
	e := &yentry.Entry{
		Name: "match",
		Key: []string{
