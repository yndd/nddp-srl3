...
func initNetworkinstanceProtocolsOspfInstanceAreaInterfaceTraceoptions(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"trace": initNetworkinstanceProtocolsOspfInstanceAreaInterfaceTraceoptionsTrace,
	}
	e := &yentry.Entry{
		Name:             "trace-options",
		Key:              []string{},
