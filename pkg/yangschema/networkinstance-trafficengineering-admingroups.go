...
func initNetworkinstanceTrafficengineeringAdmingroups(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"group": initNetworkinstanceTrafficengineeringAdmingroupsGroup,
	}
	e := &yentry.Entry{
		Name:             "admin-groups",
		Key:              []string{},
