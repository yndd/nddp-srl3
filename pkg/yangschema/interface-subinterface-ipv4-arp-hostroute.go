...
func initInterfaceSubinterfaceIpv4ArpHostroute(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"populate": initInterfaceSubinterfaceIpv4ArpHostroutePopulate,
	}
	e := &yentry.Entry{
		Name:             "host-route",
		Key:              []string{},
