...
func initSystemLoggingConsoleFacilityPriority(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"match-exact": initSystemLoggingConsoleFacilityPriorityMatchexact,
	}
	e := &yentry.Entry{
		Name:             "priority",
		Key:              []string{},
