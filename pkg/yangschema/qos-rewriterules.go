...
func initQosRewriterules(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"dscp-policy":               initQosRewriterulesDscppolicy,
		"mpls-traffic-class-policy": initQosRewriterulesMplstrafficclasspolicy,
	}
	e := &yentry.Entry{
		Name:             "rewrite-rules",
		Key:              []string{},
