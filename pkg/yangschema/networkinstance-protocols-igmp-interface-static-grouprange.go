...
func initNetworkinstanceProtocolsIgmpInterfaceStaticGrouprange(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"source": initNetworkinstanceProtocolsIgmpInterfaceStaticGrouprangeSource,
	}
	e := &yentry.Entry{
		Name: "group-range",
		Key: []string{
