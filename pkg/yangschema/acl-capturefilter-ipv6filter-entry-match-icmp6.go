...
func initAclCapturefilterIpv6filterEntryMatchIcmp6(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"code": initAclCapturefilterIpv6filterEntryMatchIcmp6Code,
	}
	e := &yentry.Entry{
		Name:             "icmp6",
		Key:              []string{},
