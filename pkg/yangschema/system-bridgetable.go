...
func initSystemBridgetable(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"mac-learning": initSystemBridgetableMaclearning,
		"mac-limit":    initSystemBridgetableMaclimit,
		"proxy-arp":    initSystemBridgetableProxyarp,
	}
	e := &yentry.Entry{
		Name:             "bridge-table",
		Key:              []string{},
