...
func initNetworkinstanceProtocolsIgmpTraceoptionsTrace(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"packet": initNetworkinstanceProtocolsIgmpTraceoptionsTracePacket,
	}
	e := &yentry.Entry{
		Name:             "trace",
		Key:              []string{},
