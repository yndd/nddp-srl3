...
func initSystemSyncFreqreferencesInstancelist(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	...
	e := &yentry.Entry{
		...
		Defaults: map[string]string{
			"admin-state":                 "disable",
			"lockout-ref":                 "false",
			"lockout-ref-bits-out":        "false",
			"priority":                    "0",
			"priority-output":             "0",
			"ql-override":                 "auto",
			"ref-ql-enable":               "true",
			"switch-ref-request":          "none",
			"switch-ref-request-bits-out": "none",
		},
	}
