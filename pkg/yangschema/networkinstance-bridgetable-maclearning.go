...
func initNetworkinstanceBridgetableMaclearning(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"aging": initNetworkinstanceBridgetableMaclearningAging,
	}
	e := &yentry.Entry{
		Name:             "mac-learning",
		Key:              []string{},
