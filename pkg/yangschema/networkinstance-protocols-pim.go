...
func initNetworkinstanceProtocolsPim(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"interface": initNetworkinstanceProtocolsPimInterface,
		"ipv4":      initNetworkinstanceProtocolsPimIpv4,
		"ipv6":      initNetworkinstanceProtocolsPimIpv6,
		"ssm":       initNetworkinstanceProtocolsPimSsm,
	}
	e := &yentry.Entry{
		Name:             "pim",
		Key:              []string{},
