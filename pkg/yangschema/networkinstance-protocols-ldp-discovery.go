...
func initNetworkinstanceProtocolsLdpDiscovery(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"interfaces": initNetworkinstanceProtocolsLdpDiscoveryInterfaces,
	}
	e := &yentry.Entry{
		Name:             "discovery",
		Key:              []string{},
