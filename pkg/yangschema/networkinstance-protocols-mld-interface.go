...
func initNetworkinstanceProtocolsMldInterface(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"ssm":           initNetworkinstanceProtocolsMldInterfaceSsm,
		"static":        initNetworkinstanceProtocolsMldInterfaceStatic,
		"trace-options": initNetworkinstanceProtocolsMldInterfaceTraceoptions,
	}
	e := &yentry.Entry{
		Name: "interface",
		Key: []string{
