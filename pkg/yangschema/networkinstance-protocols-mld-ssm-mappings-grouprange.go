...
func initNetworkinstanceProtocolsMldSsmMappingsGrouprange(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"source": initNetworkinstanceProtocolsMldSsmMappingsGrouprangeSource,
	}
	e := &yentry.Entry{
		Name: "group-range",
		Key: []string{
