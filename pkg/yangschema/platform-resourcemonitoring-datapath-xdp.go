...
func initPlatformResourcemonitoringDatapathXdp(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"resource": initPlatformResourcemonitoringDatapathXdpResource,
	}
	e := &yentry.Entry{
		Name:             "xdp",
		Key:              []string{},
