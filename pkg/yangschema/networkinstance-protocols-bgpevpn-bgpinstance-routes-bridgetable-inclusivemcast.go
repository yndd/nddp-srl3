...
func initNetworkinstanceProtocolsBgpevpnBgpinstanceRoutesBridgetableInclusivemcast(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{}
	e := &yentry.Entry{
		Name:             "inclusive-mcast",
		Key:              []string{},
		Module:           "",
		Namespace:        "",
