...
func initInterfaceSubinterfaceVlanEncap(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"single-tagged": initInterfaceSubinterfaceVlanEncapSingletagged,
		"untagged":      initInterfaceSubinterfaceVlanEncapUntagged,
	}
	e := &yentry.Entry{
		Name:             "encap",
		Key:              []string{},
