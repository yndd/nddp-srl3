...
func initInterfaceSubinterfaceIpv6Dhcprelay(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"option":        initInterfaceSubinterfaceIpv6DhcprelayOption,
		"server":        initInterfaceSubinterfaceIpv6DhcprelayServer,
		"trace-options": initInterfaceSubinterfaceIpv6DhcprelayTraceoptions,
	}
	e := &yentry.Entry{
		Name:             "dhcp-relay",
		Key:              []string{},
