...
func initNetworkinstanceProtocolsBgpevpnBgpinstanceRoutesBridgetableMacip(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	...
	e := &yentry.Entry{
		...
		Defaults: map[string]string{
			"advertise": "true",
			"advertise-arp-nd-only-with-mac-table-entry": "false",
		},
	}
