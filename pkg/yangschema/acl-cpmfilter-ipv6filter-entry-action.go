...
func initAclCpmfilterIpv6filterEntryAction(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"accept": initAclCpmfilterIpv6filterEntryActionAccept,
		"drop":   initAclCpmfilterIpv6filterEntryActionDrop,
	}
	e := &yentry.Entry{
		Name:             "action",
		Key:              []string{},
