...
func initNetworkinstanceSegmentroutingSegmentroutingpoliciesNamedpathsPath(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"hop": initNetworkinstanceSegmentroutingSegmentroutingpoliciesNamedpathsPathHop,
	}
	e := &yentry.Entry{
		Name: "path",
		Key: []string{
