...
func initNetworkinstanceIploadbalancing(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"resilient-hash-prefix": initNetworkinstanceIploadbalancingResilienthashprefix,
	}
	e := &yentry.Entry{
