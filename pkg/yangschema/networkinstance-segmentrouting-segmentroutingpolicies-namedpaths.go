...
func initNetworkinstanceSegmentroutingSegmentroutingpoliciesNamedpaths(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"path": initNetworkinstanceSegmentroutingSegmentroutingpoliciesNamedpathsPath,
	}
	e := &yentry.Entry{
		Name:             "named-paths",
		Key:              []string{},
