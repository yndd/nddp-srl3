...
func initInterfaceSubinterfaceIpv4VrrpVrrpgroupInterfacetracking(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"track-interface": initInterfaceSubinterfaceIpv4VrrpVrrpgroupInterfacetrackingTrackinterface,
	}
	e := &yentry.Entry{
