...
func initNetworkinstanceProtocolsIgmpInterfaceTraceoptionsTrace(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"packet": initNetworkinstanceProtocolsIgmpInterfaceTraceoptionsTracePacket,
	}
	e := &yentry.Entry{
		Name:             "trace",
		Key:              []string{},
