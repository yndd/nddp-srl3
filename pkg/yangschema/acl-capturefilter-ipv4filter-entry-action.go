...
func initAclCapturefilterIpv4filterEntryAction(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"accept": initAclCapturefilterIpv4filterEntryActionAccept,
		"copy":   initAclCapturefilterIpv4filterEntryActionCopy,
	}
	e := &yentry.Entry{
		Name:             "action",
		Key:              []string{},
