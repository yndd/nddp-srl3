...
func initNetworkinstanceProtocolsIsisInstanceOverload(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"immediate": initNetworkinstanceProtocolsIsisInstanceOverloadImmediate,
		"on-boot":   initNetworkinstanceProtocolsIsisInstanceOverloadOnboot,
	}
	e := &yentry.Entry{
		Name:             "overload",
		Key:              []string{},
