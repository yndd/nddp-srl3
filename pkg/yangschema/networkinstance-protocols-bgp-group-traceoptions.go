...
func initNetworkinstanceProtocolsBgpGroupTraceoptions(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"flag": initNetworkinstanceProtocolsBgpGroupTraceoptionsFlag,
	}
	e := &yentry.Entry{
		Name:             "trace-options",
		Key:              []string{},
