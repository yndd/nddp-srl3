...
func initAclCpmfilterIpv4filterEntryAction(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"accept": initAclCpmfilterIpv4filterEntryActionAccept,
		"drop":   initAclCpmfilterIpv4filterEntryActionDrop,
	}
	e := &yentry.Entry{
		Name:             "action",
		Key:              []string{},
