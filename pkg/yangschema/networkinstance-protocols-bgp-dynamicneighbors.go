...
func initNetworkinstanceProtocolsBgpDynamicneighbors(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"accept": initNetworkinstanceProtocolsBgpDynamicneighborsAccept,
	}
	e := &yentry.Entry{
