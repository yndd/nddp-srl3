...
func initNetworkinstanceProtocolsBgpGroupIpv4unicast(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"prefix-limit": initNetworkinstanceProtocolsBgpGroupIpv4unicastPrefixlimit,
	}
	e := &yentry.Entry{
		Name:             "ipv4-unicast",
		Key:              []string{},
