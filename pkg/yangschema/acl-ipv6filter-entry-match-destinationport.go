...
func initAclIpv6filterEntryMatchDestinationport(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"range": initAclIpv6filterEntryMatchDestinationportRange,
	}
	e := &yentry.Entry{
