...
func initSystemGribiserverNetworkinstance(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"source-address": initSystemGribiserverNetworkinstanceSourceaddress,
	}
	e := &yentry.Entry{
