...
func initInterfaceSubinterfaceVlan(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"encap":          initInterfaceSubinterfaceVlanEncap,
		"vlan-discovery": initInterfaceSubinterfaceVlanVlandiscovery,
	}
	e := &yentry.Entry{
		Name:             "vlan",
		Key:              []string{},
