...
func initNetworkinstanceProtocolsMldSsmMappings(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"group-range": initNetworkinstanceProtocolsMldSsmMappingsGrouprange,
	}
	e := &yentry.Entry{
		Name:             "mappings",
		Key:              []string{},
