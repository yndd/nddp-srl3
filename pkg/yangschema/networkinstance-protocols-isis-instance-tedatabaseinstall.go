...
func initNetworkinstanceProtocolsIsisInstanceTedatabaseinstall(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bgp-ls": initNetworkinstanceProtocolsIsisInstanceTedatabaseinstallBgpls,
	}
	e := &yentry.Entry{
