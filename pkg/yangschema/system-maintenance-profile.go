...
func initSystemMaintenanceProfile(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bgp":  initSystemMaintenanceProfileBgp,
		"isis": initSystemMaintenanceProfileIsis,
	}
	e := &yentry.Entry{
		Name: "profile",
		Key: []string{
