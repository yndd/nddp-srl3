...
func initNetworkinstanceProtocolsOspfInstanceTedatabaseinstall(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"bgp-ls": initNetworkinstanceProtocolsOspfInstanceTedatabaseinstallBgpls,
	}
	e := &yentry.Entry{
