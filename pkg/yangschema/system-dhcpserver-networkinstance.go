...
func initSystemDhcpserverNetworkinstance(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"dhcpv4": initSystemDhcpserverNetworkinstanceDhcpv4,
		"dhcpv6": initSystemDhcpserverNetworkinstanceDhcpv6,
	}
	e := &yentry.Entry{
