...
func initInterfaceSubinterfaceIpv6DhcpclientTraceoptions(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"trace": initInterfaceSubinterfaceIpv6DhcpclientTraceoptionsTrace,
	}
	e := &yentry.Entry{
		Name:             "trace-options",
		Key:              []string{},
