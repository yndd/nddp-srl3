...
func initQosRewriterulesMplstrafficclasspolicyMap(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"drop-probability": initQosRewriterulesMplstrafficclasspolicyMapDropprobability,
	}
	e := &yentry.Entry{
		Name: "map",
		Key: []string{
