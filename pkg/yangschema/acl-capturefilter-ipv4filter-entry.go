...
func initAclCapturefilterIpv4filterEntry(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"action": initAclCapturefilterIpv4filterEntryAction,
		"match":  initAclCapturefilterIpv4filterEntryMatch,
	}
	e := &yentry.Entry{
		Name: "entry",
		Key: []string{
