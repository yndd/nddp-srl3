...
func initSystemJsonrpcserverNetworkinstanceHttp(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"source-address": initSystemJsonrpcserverNetworkinstanceHttpSourceaddress,
	}
	e := &yentry.Entry{
		Name:             "http",
		Key:              []string{},
