...
func initAclCpmfilterIpv4filterEntryMatchSourceport(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"range": initAclCpmfilterIpv4filterEntryMatchSourceportRange,
	}
	e := &yentry.Entry{
		Name:             "source-port",
		Key:              []string{},
