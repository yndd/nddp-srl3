...
func initNetworkinstancePolicyforwardingPolicyRuleMatchIpv4(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"dscp-set": initNetworkinstancePolicyforwardingPolicyRuleMatchIpv4Dscpset,
	}
	e := &yentry.Entry{
		Name:             "ipv4",
		Key:              []string{},
