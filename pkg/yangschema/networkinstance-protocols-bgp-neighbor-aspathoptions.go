...
func initNetworkinstanceProtocolsBgpNeighborAspathoptions(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"remove-private-as": initNetworkinstanceProtocolsBgpNeighborAspathoptionsRemoveprivateas,
	}
	e := &yentry.Entry{
