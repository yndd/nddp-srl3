...
func initNetworkinstanceProtocolsMldInterfaceSsmMappingsGrouprange(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"source": initNetworkinstanceProtocolsMldInterfaceSsmMappingsGrouprangeSource,
	}
	e := &yentry.Entry{
		Name: "group-range",
		Key: []string{
