...
func initNetworkinstanceSegmentrouting(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"mpls":                     initNetworkinstanceSegmentroutingMpls,
		"segment-routing-policies": initNetworkinstanceSegmentroutingSegmentroutingpolicies,
	}
	e := &yentry.Entry{
