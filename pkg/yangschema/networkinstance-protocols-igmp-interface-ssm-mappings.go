...
func initNetworkinstanceProtocolsIgmpInterfaceSsmMappings(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"group-range": initNetworkinstanceProtocolsIgmpInterfaceSsmMappingsGrouprange,
	}
	e := &yentry.Entry{
		Name:             "mappings",
		Key:              []string{},
