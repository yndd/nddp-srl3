...
func initOamEthcfmDomainAssociationMep(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"pmon": initOamEthcfmDomainAssociationMepPmon,
	}
	e := &yentry.Entry{
		Name: "mep",
		Key: []string{
		...
		Defaults: map[string]string{
			...
			"ccm-enabled":                  "false",
			"ccm-ltm-priority":             "7",
			"lowest-fault-priority-defect": "mac-rem-err-xcon",
