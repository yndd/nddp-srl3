...
func initNetworkinstanceProtocolsMldInterfaceSsmMappings(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"group-range": initNetworkinstanceProtocolsMldInterfaceSsmMappingsGrouprange,
	}
	e := &yentry.Entry{
		Name:             "mappings",
		Key:              []string{},
