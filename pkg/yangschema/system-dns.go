...
func initSystemDns(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"host-entry":  initSystemDnsHostentry,
		"search-list": initSystemDnsSearchlist,
		"server-list": initSystemDnsServerlist,
	}
	e := &yentry.Entry{
		Name:             "dns",
		Key:              []string{},
