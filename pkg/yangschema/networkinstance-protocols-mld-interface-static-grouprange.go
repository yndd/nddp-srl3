...
func initNetworkinstanceProtocolsMldInterfaceStaticGrouprange(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"source": initNetworkinstanceProtocolsMldInterfaceStaticGrouprangeSource,
	}
	e := &yentry.Entry{
		Name: "group-range",
		Key: []string{
