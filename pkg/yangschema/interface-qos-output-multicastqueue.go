...
func initInterfaceQosOutputMulticastqueue(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"scheduling": initInterfaceQosOutputMulticastqueueScheduling,
	}
	e := &yentry.Entry{
		Name: "multicast-queue",
		Key: []string{
			"queue-id",
		},
		Module:           "",
