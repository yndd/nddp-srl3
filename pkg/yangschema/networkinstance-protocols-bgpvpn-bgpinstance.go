...
func initNetworkinstanceProtocolsBgpvpnBgpinstance(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"route-distinguisher": initNetworkinstanceProtocolsBgpvpnBgpinstanceRoutedistinguisher,
		"route-target":        initNetworkinstanceProtocolsBgpvpnBgpinstanceRoutetarget,
	}
	e := &yentry.Entry{
		Name: "bgp-instance",
		Key: []string{
