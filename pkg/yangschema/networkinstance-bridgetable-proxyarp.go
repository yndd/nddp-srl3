...
func initNetworkinstanceBridgetableProxyarp(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"duplicate-detect": initNetworkinstanceBridgetableProxyarpDuplicatedetect,
		"evpn":             initNetworkinstanceBridgetableProxyarpEvpn,
	}
	e := &yentry.Entry{
		Name:             "proxy-arp",
		Key:              []string{},
