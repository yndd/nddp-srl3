...
func initSystemSyncFreqreferences(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"instance-list": initSystemSyncFreqreferencesInstancelist,
	}
	e := &yentry.Entry{
		Name:             "freq-references",
		Key:              []string{},
		Module:           "",
		Namespace:        "",
