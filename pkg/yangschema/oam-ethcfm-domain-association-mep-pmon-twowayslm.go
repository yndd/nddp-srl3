...
func initOamEthcfmDomainAssociationMepPmonTwowayslm(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"session": initOamEthcfmDomainAssociationMepPmonTwowayslmSession,
	}
	e := &yentry.Entry{
		Name:             "two-way-slm",
		Key:              []string{},
