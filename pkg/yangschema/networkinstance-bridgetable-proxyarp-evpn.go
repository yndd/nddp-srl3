...
func initNetworkinstanceBridgetableProxyarpEvpn(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"flood": initNetworkinstanceBridgetableProxyarpEvpnFlood,
	}
	e := &yentry.Entry{
		Name:             "evpn",
		Key:              []string{},
