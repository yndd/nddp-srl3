...
func initNetworkinstanceProtocolsIsisInstanceInterlevelpropagationpolicies(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"level1-to-level2": initNetworkinstanceProtocolsIsisInstanceInterlevelpropagationpoliciesLevel1tolevel2,
	}
	e := &yentry.Entry{
