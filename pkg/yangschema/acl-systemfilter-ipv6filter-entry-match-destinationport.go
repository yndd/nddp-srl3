...
func initAclSystemfilterIpv6filterEntryMatchDestinationport(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"range": initAclSystemfilterIpv6filterEntryMatchDestinationportRange,
	}
	e := &yentry.Entry{
