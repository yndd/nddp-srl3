...
func initSystemMirroringMirroringinstanceMirrordestinationRemote(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"tunnel-end-points": initSystemMirroringMirroringinstanceMirrordestinationRemoteTunnelendpoints,
	}
	e := &yentry.Entry{
		Name:             "remote",
		Key:              []string{},
