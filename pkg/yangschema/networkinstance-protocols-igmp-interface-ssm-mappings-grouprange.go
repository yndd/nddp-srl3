...
func initNetworkinstanceProtocolsIgmpInterfaceSsmMappingsGrouprange(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"source": initNetworkinstanceProtocolsIgmpInterfaceSsmMappingsGrouprangeSource,
	}
	e := &yentry.Entry{
		Name: "group-range",
		Key: []string{
